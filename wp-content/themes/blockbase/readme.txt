...
= 3.1.29 =
* blockbase: make sure $blockbase_enqueued_font_slugs is an array

= 3.1.28 =
* Blockbase: Hide classic Menus UI to prevent user confusion

= 3.1.27 =
* blockbase: doc fragment can not be empty
