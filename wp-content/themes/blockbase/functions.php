...
/**
 * Hide classic Menus UI from Appearance menu.
 *
 * Blockbase uses block-based navigation via the Site Editor. The classic Menus
 * interface creates confusion because changes made there don't affect the site's
 * navigation, which is controlled by Navigation blocks in FSE templates.
 */
add_action(
	'admin_menu',
	function() {
