...
<div id="post-<?php esc_attr( the_ID() ); ?>" <?php post_class( 'wrap-blog-post' . esc_attr($oscend_blog_css_animation) ); ?>>
	...
	<div class="wrap-post-description">
		...
		<a class="post-avatar" href="<?php esc_url( the_author_meta( 'user_url' ) ); ?>"><img class="" src="<?php echo esc_url($oscend_src); ?>" alt="<?php esc_attr( the_author_meta( 'display_name' ) ); ?>"></a>
		<?php endif; ?>
	...
	<?php endif; ?>
	<?php if ( class_exists( 'PixthemeCustom' ) && oscend_get_option( 'blog_show_share', 'on' ) == 'on' ) : ?>
